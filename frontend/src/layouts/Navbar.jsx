...
function Navbar() {
  ...
  return (
    <header className="fixed z-50 flex h-16 w-screen justify-between items-center bg-[#981FBA] px-6 py-2.5 lg:h-20">
      ...
      <span
        className={`bg-opacity-50 absolute inset-0 h-dvh bg-black transition-opacity duration-300 ease-in-out ${ativo ? "opacity-50" : "opacity-0 pointer-events-none"}`}
