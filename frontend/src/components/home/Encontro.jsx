...
function Encontro({nome, diaI, diaF, encontro}){
  return(
    <div className={`rounded-[10px] ${encontro ? "max-w-full" : "max-w-[90%]"} md:max-w-[50%] w-full h-fit p-4 flex flex-col gap-2 border-1 border-[rgba(0,0,0,0.25)] flex-shrink-0`}>
      ...
      <a href="#" style={{backgroundImage: `url(${BannerVermelho})`}} className={`w-full p-3 font-bold text-white rounded-sm uppercase text-center text-xl bg-cover bg-no-repeat`}>Inscreva-se</a>
    </div>
  )
}
