...
function LigaHeader({ info }) {
  ...
  return (
    <div className="flex items-center gap-2.5 lg:gap-4">
      <div className="relative flex min-h-10 min-w-10 flex-shrink-0 items-center justify-center rounded-lg p-1 lg:min-h-12 lg:min-w-12">
        <img
          src={info.strBadge}
      ...
      <div className="min-w-0 flex-1">
        <p className="font-bold lg:text-lg">{info.strLeague}</p>
